...
# OpenLiteSpeed (backend local derrière Nginx)
# auto = activé dès qu'OLS est installé ; 1/0 force on/off
VZONE_OLS_ENABLED = env("VZONE_OLS_ENABLED", "auto")
...
# Nouveaux domaines/sous-domaines en OLS quand le moteur est prêt
VZONE_OLS_DEFAULT_ENGINE = env_bool("VZONE_OLS_DEFAULT_ENGINE", True)
...
VZONE_RESTIC_BIN = env("VZONE_RESTIC_BIN", "restic")
VZONE_RCLONE_BIN = env("VZONE_RCLONE_BIN", "rclone")
VZONE_BACKUP_TIMEOUT = env_int("VZONE_BACKUP_TIMEOUT", 7200)
...
VZONE_AI_TIMEOUT_SEC = env_int("VZONE_AI_TIMEOUT_SEC", 25)
VZONE_AI_MAX_TOOL_ROUNDS = env_int("VZONE_AI_MAX_TOOL_ROUNDS", 4)
VZONE_AI_TEMPERATURE = float(env("VZONE_AI_TEMPERATURE", "0.65"))
...
VZONE_AI_OLLAMA_CIRCUIT_SEC = env_int("VZONE_AI_OLLAMA_CIRCUIT_SEC", 300)
