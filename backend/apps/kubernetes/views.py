...
class KubernetesApplyView(APIView):
    ...
    def post(self, request: Request) -> Response:
        ...
        return Response({"success": True, "data": apply_manifest(data["manifest"], data.get("namespace", ""))})
...
class KubernetesDeleteView(APIView):
    ...
    def post(self, request: Request) -> Response:
        ...
        serializer.is_valid(raise_exception=True)
        data = serializer.validated_data
        return Response({"success": True, "data": delete_manifest(data["manifest"], data.get("namespace", ""))})
