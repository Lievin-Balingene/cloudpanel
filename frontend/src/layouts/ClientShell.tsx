...
import { Home, Globe, Package, LogOut, Moon, Sun, LayoutGrid, AppWindow, FolderOpen, Upload, Mail, Database, Code2, Terminal, FileCode2, GitBranch, Box, HardDrive, KeyRound } from "lucide-react";
          ...
          <div className="mx-auto flex max-w-6xl gap-1 px-2">
            {nav.map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `inline-flex items-center gap-1.5 px-3 py-2.5 text-sm ${
                    isActive
